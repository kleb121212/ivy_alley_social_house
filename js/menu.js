...
const menuData = [
  ...
  {Name:"Toppings - Meats", Description:"Bacon, Chicken (+$2), Pepperoni, Pulled Pork, Prosciutto (+$2), Salami, Spicy Sausage, Sweet Sausage", Category:"Build your Own Pizzas"},
  {Name:"Toppings - Cheeses", Description:"Burrata (+$2), Feta, Goat Cheese, Fresh Mozzarella, Parmesan, Smoked Gouda, *Vegan Cheese ", Category:"Build your Own Pizzas"},
  {Name:"Toppings - Veggies", Description:"Artichoke Hearts, Arugula, Raw Bell Peppers, Cooked Bell Peppers, Jalapenos, Portobello Mushrooms, Black Olives, Raw Onion, Caramelized Onions, Spinach", Category:"Build your Own Pizzas"},
  {Name:"Toppings - Other", Description:"Basil*, Hot Honey*, Pineapple, Beer Cheese, Garlic*", Category:"Build your Own Pizzas"},
