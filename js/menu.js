...
const menuData = [
  ...
  {Name:"Pretzel Charcuterie", Description:"2 Soft, Jumbo Pretzels with accoutrements and Honey Mustard, Social House Mustard, & Beer Cheese.", Price:"14", Category:"Appetizers"},
  ...
  {Name:"Greek Salad (Vgt, GF*)", Description:"Romaine & Arugula, Cucumber, Cherry Tomatoes, Black Olives, Bell Pepper, Red Onion, & Feta Cheese in a Greek Vinaigrette.", Price:"12", Category:"Soup & Salad"},
  ...
  {Name:"Soup Du Jour", Description:"Hmm… Sounds Delicious.", Price:"5 (Cup) $8 (Bowl)", Category:"Soup & Salad"},
  {Name:"Potato Bacon", Description:"A Cream of potato soup with chunks of potato, bacon, & veggies.", Price:"5 (Cup) $8 (Bowl)", Category:"Soup & Salad"},
  ...
  {Name:"Why not’ta Burrata (Vgt)", Description:"Tomato Sauce, House Cheese Blend, & a Large Burrata Ball with Basil & Oregano.", Price:"8 | $16", Category:"House Pizzas"},
  {Name:"Shroomzza (Vgt)", Description:"Olive Oil & Goat Cheese Base, House Cheese Blend, Mushrooms, with Thyme & Oregano.", Price:"8 | $14", Category:"House Pizzas"},
  ...
  {Name:"Toppings - Meats", Description:"Bacon, Chicken (+$2), Pepperoni, Pulled Pork, Prosciutto (+$2), Salami, Spicy Sausage, Sweet Sausage", Price:"2 each", Category:"Build your Own Pizzas"},
  {Name:"Toppings - Cheeses", Description:"Burrata (+$2), Feta, Goat Cheese, Fresh Mozzarella, Parmesan, Smoked Gouda, *Vegan Cheese ", Price:"2 each", Category:"Build your Own Pizzas"},
  {Name:"Toppings - Veggies", Description:"Artichoke Hearts, Arugula, Raw Bell Peppers, Cooked Bell Peppers, Jalapenos, Portobello Mushrooms, Black Olives, Raw Onion, Caramelized Onions, Spinach", Price:"2 each", Category:"Build your Own Pizzas"},
  {Name:"Toppings - Other", Description:"Basil*, Hot Honey*, Pineapple, Beer Cheese, Garlic*", Price:"2 each", Category:"Build your Own Pizzas"},
  ...
  {Name:"Pepsi Products", Description:"", Price:"3", Category:"Beverages"},
  {Name:"Milk", Description:"", Price:"3", Category:"Beverages"},
  {Name:"Chocolate Milk", Description:"", Price:"3", Category:"Beverages"},
